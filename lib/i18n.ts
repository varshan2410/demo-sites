...
Object.assign(translations.si, { "print.clinic.title": "හමුවීමේ රිසිට්පත", "print.requestReceived": "ඉල්ලීම ලැබුණි", "print.reference": "යොමු අංකය", "print.patient": "රෝගියා", "print.treatment": "ප්‍රතිකාරය", "print.dentist": "කැමති දන්ත වෛද්‍යවරයා", "print.requestedDate": "ඉල්ලූ දිනය", "print.requestedTime": "ඉල්ලූ වේලාව", "print.status": "තත්ත්වය", "print.pendingConfirmation": "තහවුරු කිරීම බලාපොරොත්තුවෙන්", "print.clinic.note": "මෙය ඉල්ලීම් රිසිට්පතක් වන අතර තහවුරු කළ හමුවීමක් නොවේ. ඔබගේ පැමිණීම තහවුරු කිරීමට අපගේ කණ්ඩායම WhatsApp හරහා සම්බන්ධ වේ." });
Object.assign(translations.ta, { "print.clinic.title": "சந்திப்பு ரசீது", "print.requestReceived": "கோரிக்கை பெறப்பட்டது", "print.reference": "குறிப்பு", "print.patient": "நோயாளர்", "print.treatment": "சிகிச்சை", "print.dentist": "விருப்பமான பல் மருத்துவர்", "print.requestedDate": "கோரிய தேதி", "print.requestedTime": "கோரிய நேரம்", "print.status": "நிலை", "print.pendingConfirmation": "உறுதிப்படுத்தல் நிலுவையில்", "print.clinic.note": "இது கோரிக்கை ரசீது; உறுதிப்படுத்தப்பட்ட சந்திப்பு அல்ல. உங்கள் வருகையை உறுதிப்படுத்த எங்கள் குழு WhatsApp மூலம் தொடர்புகொள்ளும்." });

Object.assign(translations.si, { "print.hotel.title": "නවාතැන් විමසුම් වවුචරය", "print.enquiryReceived": "විමසුම ලැබුණි", "print.guest": "අමුත්තා", "print.roomPreference": "කාමර තේරීම", "print.checkIn": "පැමිණීම", "print.checkOut": "පිටවීම", "print.guests": "අමුත්තන්", "print.pendingAvailability": "ලබාගත හැකි බව බලාපොරොත්තුවෙන්", "print.hotel.note": "මෙය ලබාගත හැකි බව පිළිබඳ විමසුමක් වන අතර තහවුරු කළ නවාතැන් ගත වීමක් නොවේ. අවසාන LKR මිල සහ ලබාගත හැකි බව තහවුරු කිරීමට අපගේ කණ්ඩායම සම්බන්ධ වේ." });
Object.assign(translations.ta, { "print.hotel.title": "தங்கல் விசாரணை வவுச்சர்", "print.enquiryReceived": "விசாரணை பெறப்பட்டது", "print.guest": "விருந்தினர்", "print.roomPreference": "அறை விருப்பம்", "print.checkIn": "வருகை", "print.checkOut": "புறப்பாடு", "print.guests": "விருந்தினர்கள்", "print.pendingAvailability": "கிடைப்புத் தன்மை நிலுவையில்", "print.hotel.note": "இது கிடைப்புத் தன்மை விசாரணை; உறுதிப்படுத்தப்பட்ட தங்கல் அல்ல. கிடைப்புத் தன்மை மற்றும் இறுதி LKR விலையை உறுதிப்படுத்த எங்கள் குழு தொடர்புகொள்ளும்." });
